...
export const routes: Routes = [
    ...
    { path: 'kvp', loadChildren: ()=> import('./kvp/kvp.routes').then(mod => mod.KvpRoutes)},
    { path: 'kvr', loadChildren: ()=> import('./kvr/kvr.routes').then(mod => mod.KvrRoutes)},
    { path: 'kve', loadChildren: ()=> import('./kve/kve.routes').then(mod => mod.KveRoutes)},
    { path: 'kva', loadChildren: ()=> import('./kva/kva.routes').then(mod => mod.KvaRoutes)},
